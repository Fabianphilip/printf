 ...
 *
 * @inv: pointer to the arguments inventory containing commonly used arguments
 * @n: unsigned long integer to be printed in octal
 * @size: size to be allocated in memory for octal string
 */
